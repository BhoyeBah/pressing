 ...
 */
class getPressingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PressingRepository' shared autowired service.
     *
     * @return \App\Repository\PressingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PressingRepository.php';

        return $container->privates['App\\Repository\\PressingRepository'] = new \App\Repository\PressingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
