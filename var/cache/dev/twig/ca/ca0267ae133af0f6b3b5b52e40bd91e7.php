...
class __TwigTemplate_201a245a5990c6488a4efe7f4f87cf9a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        yield "    <h1>Bienvenue sur votre tableau de bord, ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 4, $this->source); })()), "user", [], "any", false, false, false, 4), "nom", [], "any", false, false, false, 4), "html", null, true);
        yield "!</h1>
    <!-- Ajoutez ici le contenu spécifique au tableau de bord des membres -->
";
...
{% block body %}
    <h1>Bienvenue sur votre tableau de bord, {{ app.user.nom }}!</h1>
    <!-- Ajoutez ici le contenu spécifique au tableau de bord des membres -->
