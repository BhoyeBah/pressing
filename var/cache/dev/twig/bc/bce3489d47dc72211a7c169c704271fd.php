...
class __TwigTemplate_40c5751b858c54ac0e5058d0ec80114f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 71
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["totalClients"]) || array_key_exists("totalClients", $context) ? $context["totalClients"] : (function () { throw new RuntimeError('Variable "totalClients" does not exist.', 71, $this->source); })()), "html", null, true);
        yield "</h3>
...
";
    ...
    {
        return array (  166 => 71,  110 => 17,  102 => 15,  100 => 14,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
                    ...
                    <div class=\"d-flex align-items-end row\">
                        <div class=\"col-sm-7\">
                            <div class=\"card-body\">
                                <h5 class=\"card-title text-primary\">
                                    {% if app.user %}
                                        Bienvenu Mr {{ app.user.nom }} {{ app.user.prenom }} ! 🎉
                                    {% endif %}
                                </h5>
                                <p class=\"mb-4\">
                                    You have done <span class=\"fw-bold\">72%</span> more sales today. Check your new badge in
    ...
    <!-- / Content -->
{% endblock %}
", "home_page/index.html.twig", "C:\\xampp\\htdocs\\myapp\\templates\\home_page\\index.html.twig");
    }
}
