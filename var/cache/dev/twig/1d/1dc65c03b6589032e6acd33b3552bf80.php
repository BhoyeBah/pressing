...
/* user/new.html.twig */
class __TwigTemplate_674472d481733ccfa903483d6305e703 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "<h4 class=\"fw-bold py-3 mb-4\"><span class=\"text-muted fw-light\">Formulaire/</span> d'ajout d'un utilisateur' <a href=\"";
...
{% block title %}New Modules{% endblock %}

{% block body %}
<h4 class=\"fw-bold py-3 mb-4\"><span class=\"text-muted fw-light\">Formulaire/</span> d'ajout d'un utilisateur' <a href=\"{{ path('app_users_index') }}\" class=\"btn btn-info\"><i class=\"bx bx-list\"></i>Liste des utilisateurs</a></h4>
    {{ include('user/_form.html.twig') }}
{% endblock %}
", "user/new.html.twig", "C:\\xampp\\htdocs\\myapp\\templates\\user\\new.html.twig");
    }
}
