 ...
 */
class getDemandePressingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandePressingRepository' shared autowired service.
     *
     * @return \App\Repository\DemandePressingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandePressingRepository.php';

        return $container->privates['App\\Repository\\DemandePressingRepository'] = new \App\Repository\DemandePressingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
